...
## Author  : Xwann Cl4rk
## Twitter : @WannMaz
## Github  : https://github.com/Xwann77
##Instagram: https://www.instagram.com/_setyawan77
...
banner () {
    ...
    echo "
               ...
               ${BLUE}               ...         .....          ...
               ${BLUE}             ....      ..i:cldddoi,:;i.     ...
               ${BLUE}           ...      .:x; lddkOkkxdo:.:li      ...
               ${BLUE}          ...       ko.;:,ox0Kk0kdol,.o.       ...
               ${BLUE}          ...        okl:c:,,....,:c;,d,       ...
               ${BLUE}           ...        c0d:nn......;lO;        ...
               ${BLUE}          ....         .kXNXK00KXXk.          ....
               ${BLUE}          ...            ;xXX0OKk.              ...
               ...
               ${BLUE}        ...                                         ...
               ${BLUE}       ... ${RED} ======================================== ${BLUE}...
               ${BLUE}      ...  ${RED} |  ${BLUE}Created by:                         ${RED}|  ${BLUE}...
               ${BLUE}      ...  ${RED} |    ${GREEB} ▒█▀▀█ ▒█░░░ ░█▀█░ ▒█▀▀█ ▒█░▄▀    ${RED}|   ${BLUE}...
    ...
    ${BLUE}│${RED}░░▀░░▀▀▀░▀░▀░▀░▀░▀▀▀░▀░▀${ORANGE}░░░░░${GREEN}▀▀▀░░▀░░░▀░░▀▀▀░▀▀▀░░${BLUE}│
    ${BLUE}└──────────────────────────────────────────────────┘
    ${BLUE}[${RED}*${BLUE}] ${ORANGE}By- CL4RK ${RED}//${ORANGE} XWANN"
